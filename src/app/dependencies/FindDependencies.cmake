if(ENABLE_V3CRTP)
	...
	find_package(uvgV3CRTP 0.10.0 QUIET) #TODO: update min version to a version with necessary bug fixes etc.

	# Try pkgConfig as well
	find_package(PkgConfig QUIET)
	if(PkgConfig_FOUND)
		if(NOT UVGV3CRTP_FOUND)
			pkg_search_module(UVGV3CRTP uvgv3crtp>=0.10.0 uvgV3CRTP>=0.10.0)
		endif()
	endif()
